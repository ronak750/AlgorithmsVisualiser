...
//             g.fillRect(x_min+i*width, y_min, width-2, array[i]);
    ...
    void insertionSort() throws InterruptedException
    {
        ...
        for(int i=0;i<arraySize;i++)
        {
            ...
            {
//                resetRectangle(k,g);
//                g.setresetReColor(initial_color);
...
//        resetAndRedraw(high);
    ...
    void heapSort() throws InterruptedException
    {
    ...
    public void  selectionSort() throws InterruptedException
    {
        for(int i=0;i<arraySize;i++)
        {
            ...
            for(int j=i+1;j<arraySize;j++)
            {
                ...
                {
                    if(minIndex!=i)
                        drawRectangle(minIndex,initial_color);
                    drawRectangle(j,temp_color);
                    minm=array[j];
                    minIndex=j;
                    Thread.sleep(delay);
                }
            ...
            swap(i,minIndex,graphics);
            Thread.sleep(delay);
            resetAndRedraw(minIndex);
            reDraw(i,final_color);
//            drawRectangle(i,final_color);
        }
        reDraw(arraySize-1,final_color);
    }
