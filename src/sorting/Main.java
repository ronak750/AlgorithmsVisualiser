...
import others.DemandPagingController;
...
public class Main extends javax.swing.JFrame {
    ...
    private int x_window=(int) screenSize.getWidth()*100/100;
...
JLabel j2=new JLabel("Page Replacement");

JLabel jLabel4=new JLabel("Page Replacement");
jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
jLabel4.setFont(new java.awt.Font("Tahoma", 3, 24)); // NOI18N
jLabel4.setForeground(new java.awt.Color(153, 0, 153));
c.fill = GridBagConstraints.HORIZONTAL;
...
JTextArea jta=new JTextArea("Visualise the page replacement algorithms which\nmake demand paging possible. Also compare\npage fault rates"
        + "for various algorithms. viz FIFO,\nMRU LRU, Optimal, MFu, LFU ");
jta.setEditable(false);
jta.setColumns(20);
jta.setFont(new java.awt.Font("Rupee Foradian Standard Serif", 0, 18)); // NOI18N
jta.setRows(5);
...
JLabel jLabel4=new JLabel("Searching");
jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
jLabel4.setFont(new java.awt.Font("Tahoma", 3, 24)); // NOI18N
jLabel4.setForeground(new java.awt.Color(153, 0, 153));
c.fill = GridBagConstraints.HORIZONTAL;
...
//jScrollPane2.setViewportView(jTextArea2);
JTextArea jta=new JTextArea("Visualise searching of elements. \nThis features various element searching viz\n Linear Search and Binary search\n also searching of nodes in graph using\nBFS,DFS dijikstra, and A*");
jta.setEditable(false);
jta.setColumns(20);
jta.setFont(new java.awt.Font("Rupee Foradian Standard Serif", 0, 18)); // NOI18N
jta.setRows(5);
...
private void paging(ActionEvent evt) {
//           throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
